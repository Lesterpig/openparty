 ...
 *
 * @param  {String} [channel]
 * @param  {Socket} player     /!\ player's socket, not player object's!
 * @param  {String} value
 */
...
Room.prototype.start = function() {
    ...
    this.gameplay.start(this, function(err) {
        if(err) {
            return this.socket.emit("chatMessage", { message: err });
        }
...
/**
 * End the current stage and start another stage
...
var rooms = module.exports = {
    ...
    createRoom: function(name, type, socket) {
        ...
        var room = new Room(name, gameplay);
